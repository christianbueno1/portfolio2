...
import resume_christian_bueno_espanol from '/resume-christian-bueno-espanol.pdf'
        ...
        <div className='flex flex-col justify-center'>
          ...
          <div>
            <button className='group px-6 py-3 my-2  bg-gradient-to-r from-amber-400 to-amber-200 rounded-lg' >
              <a href={resume_christian_bueno_english} download target='_blank' className='flex items-center' rel='noreferrer'>
                Resume English
            ...
            <button className='group px-6 py-3 my-2  bg-gradient-to-r from-amber-400 to-amber-200 rounded-lg sm:ml-8' >
              <a href={resume_christian_bueno_espanol} download target='_blank' className='flex items-center' rel='noreferrer'>
